...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF6F6AA5);
  late Color secondary = const Color(0xFF406F80);
  late Color tertiary = const Color(0xFFE3D085);
  late Color alternate = const Color(0xFFEAEAE9);
